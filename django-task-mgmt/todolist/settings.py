...
## TO prepare to heroku
if DATABASES['default']['ENGINE'] == 'postgresql_psycopg2':
...
SECRET_KEY = 'pqq_fd-c*rz_&amp;uqrc)^^2wgtqkq=)--g(m!es2z*&amp;q=sns1(1g'
...
TEMPLATE_DIRS = (
    ...
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    os.path.join(os.path.dirname(__file__), '../tasks/templates'),
)
